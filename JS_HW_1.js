...
let item_4 = null;                      //  10. Создать переменную “item_4”
...
console.log('item_3 x item_4 =', item_3 * item_4); //  14. Вывести в консоль умножение item_3 и item_4.
let item_5 = null;                      //  15. Создать переменную “item_5”
item_5 = item_3;                        //  16. Присвоить переменной item_5 переменную item_3
let item_6 = null;                      //  17. Создать переменную item_6.
let item_6_type = null;                 //  18. Создать переменную item_6_type
...
let item_7_type = null;                        //  23. Создать переменную item_7_type
