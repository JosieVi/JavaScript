...
// Первый вариант:
let i = ['09.10.2021', '10.10.2021'];
i.forEach(element => console.log(users.filter(item => item.registrationDate === element)));

// Второй вариант:
//   for (let key in users) {
//     if (users[key].registrationDate == '09.10.2021' || users[key].registrationDate == '10.10.2021') console.log(users[key]);
//   }